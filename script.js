// ---- kirim jawaban ke Google Sheets (via Apps Script) ----
...
function kirimJawaban(jawaban) {
  if (SHEET_URL.includes("GANTI_DENGAN")) {
    console.warn("SHEET_URL belum diganti, jawaban belum tersimpan ke Sheets.");
    return;
  }
  fetch(SHEET_URL, {
    method: "POST",
...
yesBtn.addEventListener('click', () => {
  playYesSound();
  kirimJawaban("iya, jemput aku ya");
